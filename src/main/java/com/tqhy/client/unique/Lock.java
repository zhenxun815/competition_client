...
class Lock {
     ...
     * @param lockFileChannel The channel associated to the lock file.
     * @param lockFileLock    The file lock taken on the lock file.
     * @param server          The server handling message reception for this lock.
     */
